...
class SettingsViewModel: SettingViewModelProtocol {
    ...
    var numberOfPhotoItems: String {
        get {
            String(UserSettingManager.shared.getCountOfPhotosPerRowFor(photoCollectionView: true))
        } set {
    ...
    var numberOfFavoriteItems: String {
        get {
            String(UserSettingManager.shared.getCountOfPhotosPerRowFor(photoCollectionView: false))
        } set {
            viewModelDidChange?(self)
        }
    }
